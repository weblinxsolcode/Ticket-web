...
export default function Ourbonus() {
  const scroll = () => {
    window.scrollTo(0,0); 
    console.log("scroll value reset")
  }

  const [ourbonus, setourbonus] = useState([])
  const ourbonusdata = async () => {
    await axios.post(`${config.baseURL}/all-content.php`)
      .then(async (response) => {
        setourbonus( await response.data[3]);
        console.log(ourbonus)
        
      })
  }
const desc = ourbonus.description
  useEffect(() => {
    ourbonusdata();
    scroll();
  }, [])
          ...
          <div className="row">
            <div className="col-lg-12 col-md-12 col-sm-12">
              <div className="banner_text text-center">
                ...
                { ReactHtmlParser(ourbonus.title) }
          ...
          <div className="container">
            <div className="row align-items-center">
              <div className="col-lg-12 col-md-12 col-sm-12">
                ...
                { ReactHtmlParser(ourbonus.description) }

                    {/* {ourbonus.description} */}
                  </p>
